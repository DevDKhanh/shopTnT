function Toast({
    ...
    if (main) {
        ...
        if (style === 1) {
            ...
            toast.classList.add('toast-2');
            toast.innerHTML = `
            <div class="toast-2-content">
                <div class="toast-2__msg">
                    Đang xử lý
                </div>
                <div class="toast-2__icon icon--img">
                    <img style="width: 100%" src="/img/Spinner.png"/>
                </div>
            </div>
            `;
        } else {
        ...
        dialog.innerHTML = `
            <div class="dialog">
                ...
                <div class="dialog__actions">
                    ...
                    <div class="btn btn-secondary btn-cancel">${cancelBtn}</div>
                </div>
            </div>
        `;
